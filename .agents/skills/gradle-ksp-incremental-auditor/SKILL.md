---
name: gradle-ksp-incremental-auditor
description: Verifies Room and other KSP processors are configured for 100% incremental execution.
---

# gradle-ksp-incremental-auditor

## Description
Verifies Room and other KSP processors are configured for 100% incremental execution.

## Instructions
Ensure `ksp.incremental=true` is set and that no processor globally breaks incremental processing by inspecting the KSP logs.
