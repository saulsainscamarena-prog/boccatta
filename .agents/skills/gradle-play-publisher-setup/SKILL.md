---
name: gradle-play-publisher-setup
description: Configures Triple-T Play Publisher Plugin to upload AABs and mapping files to Google Play Console.
---

# gradle-play-publisher-setup

## Description
Configures Triple-T Play Publisher Plugin to upload AABs and mapping files to Google Play Console.

## Instructions
Apply `com.github.triplet.play` plugin. Configure credentials and track (e.g. internal, alpha) to automate Play Store distribution.
